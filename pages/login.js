...
function Login() {
  ...
  return (
    <>
      <Head>
        <title>SamakiZetu | Login</title>
      </Head>

      <div style={{
      backgroundImage: 'url("https://images.pexels.com/photos/2344572/pexels-photo-2344572.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")',
      height: "100%", backgroundRepeat: "cover"
    }}>

      <div className="grid xl:grid-cols-2 gap-40 pt-24 px-32">
        <div className="pb-10 xl:px-10 mx-auto  pt-55">
          <h1 className="text-4xl text-primary">SamakiZetu</h1><p className="text-4l text-white">A platform that
          gives you access to <br /> a secure Fishing Tracking system. Developed <br />{" "}
        ...
        <div className="bg-white p-10 py-32 text-center">
          {!pressed ? (
            ...
            <div className="card flex flex-col justify-center items-center">
              <h1 className="text-primary text-4xl">Welcome</h1>
              <CheckCircle
                width={80}
                height={80}
