...
function Dashboard() {
  ...
  const filled = formatNumber(polls.filter((x) => x.voteed).length);
  ...
  return (
    <div>
      <Head>
        <title>SamakiZetu | Dashboard</title>
      </Head>
      <Sidebar />
        ...
        <div className="mx-4 flex xl:flex-row flex-col xl:justify-between">
          <div className="xl:px-4 w-full mb-4">
            ...
            <div className="flex xl:flex-row flex-col justify-between">
              <Card className="w-full xl:mr-4 mr-0">
                <div className="flex justify-between items-center">
                  <span className="font-bold text-xl">Your Tracker Information</span>
              ...
              <Card className="w-full">
                <div className="flex justify-between items-center mb-4">
                  <span className="font-bold text-xl">
                    Create <br /> or find a Fish Tracker
                  </span>
                  <span>{Lightning}</span>
                </div>
                <Button
                  onClick={() => router.push(routeNames["create-tracker"])}
                  color="primary"
                  size="sm"
                  className="mr-4 mb-4"
                >
            ...
            <div className="justify-center flex">
              <Link href="/tracker-history?filter=true">
                <a className="text-center text-primary underline font-thin">
                  See more active Tracker
                </a>
              </Link>
            </div>
          </div>
          ...
          <Card className="w-full xl:w-96">
            <div className="flex justify-between items-center">
              <span className="font-bold text-xl">Recent Tracker</span>
              <span>{Rate}</span>
            </div>
