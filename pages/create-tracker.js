...
function CreatePoll() {
    ...
    if (percentage >= 100) {
      createPoll()
        ...
        .catch((e) => {
          ...
          alert(
            "Oops, please ensure you filled the form correctly. " +
              e.message
          );
        });
    } else {
  ...
  return (
    <div className="w-full">
      <Head>
        <title>SamakiZetu | Create a Tracker</title>
      </Head>
      <Sidebar />
        ...
        <Card className="rounded-b-none">
          <div className="flex justify-between flex-col sm:flex-row">
            <span className="mb-4">
              ...
              <span className="text-3xl">Create a Tracker</span>
            </span>
            <span className="w-48">
            ...
            <div className="grid gap-10 xl:grid-cols-3 grid-cols-1">
              <div className="form lg:col-span-2">
                <Input
                  ...
                  id="pollName"
                  label="Fish"
                  placeholder="Enter the type of Fish here"
                ...
                <Input
                  ...
                  textArea
                  label="description"
                  placeholder="Enter Details for Tracking"
                  id="description"
                  onChange={handleChange}
                />
